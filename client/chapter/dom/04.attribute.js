...
console.log(first.hasAttribute('id')) //해당 속성이 있는지 체크.


// - elementNode.getAttribute(name) – 속성값을 가져옴
console.log(first.getAttribute('sayHi')); //모든 비표준 속성을 다 순환할 수 있음.
...
first.dataset.name = 'yerin' //setter //dateset 사용하면 html에 data-name이라는 이름으로 들어감.
...
/*
스몰 과제(검사하는 건 아니고 그냥 해보기)
 => prop에 data가 있어? 그럼 datatset으로 넣기
