...
//iterable 요소: string 문자, array 배열
...
//유사 배열 (배열은 아닌데 배열 같이 생김.)
const arrayLike={
  0: 'body',
  1: 'head',
  2: 'div',
  length: 3
  //symbol(symbol.iterator)(){} //이렇게 이터러블 설정 해주면 for of 순환 가능.
}

//만약 arrayLike를 순환한다면 오류남. 객체여서 이터러블 요소가 아니기 때문.
/*
...
//for in문 거의 안씀. 그럼 객체 for.of쓸 때 계속 심볼 써줘야 하냐.
//놉. 객체=>배열 한 다음에 for..of
